...
Каждая нетривиальная задача проходит три обязательных этапа:

**1. Анализ** — изучить затронутый код, уточнить требования до полной ясности, спланировать подход.

**2. Выполнение** — реализовать пошагово.

**3. Проверка** — после завершения обязательно прогнать статические анализаторы:
```bash
...
```
Задача считается выполненной только если все три прошли без ошибок. При ошибках — вернуться на этап «Анализ» или «Выполнение» в зависимости от характера проблемы, исправить, повторить проверку.
