...
```
Задача считается выполненной только если оба прошли без ошибок. При ошибках — вернуться на этап «Анализ» или «Выполнение» в зависимости от характера проблемы, исправить, повторить проверку.
